    ...
    <body>
        <div id="app" class="container" v-if='this.loading'>
            ...
            <div class='main'>
                <div class="count_list">
                    <select class="select" v-model='type' @change='getCounter(type,prec)'>
                        <option v-for='item in events' :value='item.type'>@{{item.val}}</option>
                    </select>
                    <select class="select" v-model='prec' @change='getCounter(type,prec)'>
        ...
        <script>
            let app = new Vue({
                ...
                methods:{
                    getCounter:function(type,prec){
                        axios.post('/count/getCounter',{
                            name:type,
                            precision:prec
                        })
                        .then(res=>{
                    ...
                    updateCounter:function(name){
                        axios.post('/count/updateCounter',{
                            name:name
                        })
                        .then(res=>{
                            if(res.data&&res.data.success){
